...
//The number of Objects to be created by application should be huge.to reduce memory usage by sharing as much data as possible

//The object creation is heavy on memory and it can be time consuming too.use caches to improve response time
